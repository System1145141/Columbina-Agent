...
export const VAULT_README_MD = `# Columbina Learn Workspace

This is your **Columbina Learn workspace**. Columbina will help you read materials, take notes, create exercises, track progress, and review what you have learned.
...
| \`notes/\` | Learning notes maintained by you and Columbina. |
| \`exercises/\` | Exercises, quizzes, mistakes and review notes. |
| \`templates/\` | Reusable templates for notes and reviews. |
| \`learn/progress.md\` | Overall learning progress, maintained by Columbina. |
...
2. Tell Columbina: "I want to learn this."
3. Columbina will read the material, discuss it with you, and offer to take notes in \`notes/\`.
4. After a learning session, Columbina will update \`learn/progress.md\` silently.

> Do not manually edit \`learn/progress.md\` unless you know what you are doing. Columbina keeps it up to date after each session.
`;
...
Columbina reads files in this directory when you ask about them. By default she does **not** modify files here, so your originals stay intact.
...
This is where Columbina writes learning notes for you, and where you can write your own notes too.
...
- Add tags like ` + "`#concept`" + ` or ` + "`#paper`" + ` so Columbina can find them later.
`;
...
- Mark questions you still find difficult so Columbina can revisit them.
`;
